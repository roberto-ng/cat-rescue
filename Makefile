...
APP_TITLE		:= Cat Rescue
APP_DESCRIPTION	:= Jogo mt legal
APP_AUTHOR		:= https://github.com/robertonazareth/
...
$(TARGET):
	em++ -Iinclude -Iinclude/spritesheets source/*.cpp source/spritesheets/*.cpp -O2 -std=c++11 -o html/index.html --embed-file data -O2 -s USE_SDL=2 -s USE_SDL_IMAGE=2 -s SDL2_IMAGE_FORMATS='["png"]' 
else
ifeq ($(ENV), ENVWIN)
TARGET = cat_rescue.exe

$(TARGET):
	i686-w64-mingw32-g++ -o cat_rescue.exe -Iinclude -Iinclude/spritesheets source/*.cpp source/spritesheets/*.cpp -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -mwindows -static-libgcc -static-libstdc++ -Wl,-Bstatic -lstdc++ -lpthread -Wl,-Bdynamic -std=c++11
else
TARGET = cat_rescue

$(TARGET):
	g++ -m32 -o $@ -Iinclude -Iinclude/spritesheets -m32 -lSDL2 -m32 -lSDL2_image source/*.cpp source/spritesheets/*.cpp -std=c++11
endif
endif
endif
